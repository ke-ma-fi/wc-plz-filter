...
final class WC_PLZ_Filter {
    ...
    public function init(): void {
        ...
        if ( ! class_exists( 'WooCommerce' ) ) {
            add_action( 'admin_notices', function() {
                echo '<div class="notice notice-error"><p><strong>DT Woohoo:</strong> WooCommerce muss aktiv sein.</p></div>';
            });
    ...
    /**
     * Tab-Inhalt für Woohoo_Module_Delivery. Rendert nur den Inhalt (kein
     * <div class="wrap">/<h1> - das übernimmt Woohoo_Admin_Page), damit die
     * bestehende Logik unverändert innerhalb der gemeinsamen Tab-Seite läuft.
     */
    public function render_delivery_tab(): void {
        if ( ! current_user_can( self::MANAGE_CAP ) ) {
            return;
        }
